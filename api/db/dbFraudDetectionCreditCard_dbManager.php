...
function getConnection() {
	...
	global $db_FraudDetectionCreditCard_db_Url, $db_FraudDetectionCreditCard_db_User, $db_FraudDetectionCreditCard_db_Pass, $db_FraudDetectionCreditCard_db_DbName;
	
	try {
		$dbh = new PDO("mysql:host=".$db_FraudDetectionCreditCard_db_Url.";dbname=".$db_FraudDetectionCreditCard_db_DbName, $db_FraudDetectionCreditCard_db_User, $db_FraudDetectionCreditCard_db_Pass);
